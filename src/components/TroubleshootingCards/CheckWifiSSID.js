        ...
        <div className="troubleshoot-sect">
            ...
            <div className="troubleshoot-card">
                <ul className="troubleshoot-list">
                    ...
                    <li className="troubleshoot-list-item">
                        If the this does not resolve the issue or tech is unable to set SSID broadcast to 'Public', please move on to the other troubleshooting steps for 'No Wi-Fi'.
                    </li>
                </ul>
            </div>
